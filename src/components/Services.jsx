        ...
        <section className="services">
            <div className="wrapper-services reverse">
                <div className="content-services">
                    <h2><strong>Artinka</strong></h2>
                    <div>
                        <p>ARTinka zajmuję się głównie <strong>malowaniem twarzy</strong> na różnego rodzaju imprezach tematycznych. Możesz wynająć mnie na: </p>
                        <ul>
                                <li>urodzinki</li>
                                <li>festyny</li>
            ...
            <div className="wrapper-services">
                <div className="content-services">
                    ...
                    <div>
                        ...
                        <ul className='list'>
                            ...
                            <li>kreatywne gry zespołowe z wykorzystaniem pistoletów na podczerwień (laser tag)</li>
                        </ul>
                    </div>
                </div>
                <div className="photos-services">
                ...
                <p className='text'>Każda z tych usług to dodatkowa atrakcja do Twojej imprezy.</p>
                <p className='text'>Stwórz swoje własne stanowiska animacyjne i baw się razem z <strong>ARTinką!</strong></p>
            </div>
        </section>
     );
}
