        ...
        <section className="advantages">
            <div className="content-advantages">
                ...
                <div className="advantage-box">
                    ...
                    <p>Dzieci uwielbiają <strong>malowanie twarzy</strong>, a ich radość maluje się sama.</p>
                </div>
                <div className="advantage-box">
                    <img src={brain} alt="" />
                    <h4>Kreatywność</h4>
                ...
                <div className="advantage-box">
                    ...
                    <p><strong>Malowaniem twarzy</strong> zajmuję się od lat i stawiam na ciągły samorozwuj.</p>
                </div>
            </div>
        </section>
     );
