					...
					<div className="priceList-wrapper">
						<div className="priceList-box">
							...
							<div className="priceList-block">
								<p>
									zabawy mniejsze, do 25 osób (np. urodzinki, komunie, wesela,
									itp.)
								</p>
								<span>
									130 zł/
							...
							<div className="priceList-block">
								<p>
									...
									koncerty, festiwale, pikniki, imprezy firmowe, dożynki, itp.)
								</p>
								<span>
									180 zł/<sub>h</sub>
								</span>
						...
						<div className="priceList-box">
							...
							<div className="priceList-block">
								<p>
									Zespołowy sport z wykorzystaniem pistoletów na podczerwień.
									Jednocześnie może grać 10 osób.
								</p>
								<span>
									15 zł/<sub>osobę</sub>
								</span>
						...
						<div className="priceList-box">
							...
							<div className="priceList-block">
								<p>
									Kreatywne koralik. To kreatywna zabawa, z któej może powstać
									wiele cikawych rzeczy.
								</p>
								<span>
									10 zł/<sub>osobę</sub>
								</span>
						...
						<div className="priceList-box">
							...
							<div className="priceList-block">
								<p>
									Przypinki i magnesy podczas dużych imprez, festynów, imprez
									firmowych.
								</p>
								<span>
						...
						<div className="priceList-box">
							...
							<div className="priceList-block">
								<p>
									Dzieci otrzymują balony wykonane przez animatora, mogą wybrać
									sobie wzór, a później samodzielnie je ozdobić.
								</p>
								<span>
									100 zł/<sub>h</sub>
								</span>
						...
						<div className="priceList-box">
							...
							<div className="priceList-block">
								<p>
									Kącik, w którym tworzę przestrzeń dla mniejszych dzieci, ale
									nie tylko.
								</p>
								<span>
									70 zł/<sub>h</sub>
